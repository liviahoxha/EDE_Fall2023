...
#Create a variable that has the names of the columns 
my_col.names <- c('County','$\\mu g/m^3$')

#Now I create the PM2.5 table, then name the columns and put the title
knitr::kable(summary_PM25, 
    col.names = my_col.names, 
    caption = 'Mean Particulates (2.5mm)')

#Create the Ozone table,then name the columns and add the title
...
# Here I filter the data for records collected in 2018
ozone_2018 <- epa_data %>% 
...
# Now I filter the data for records collected in 2019
ozone_2019 <- epa_data %>% 
...
## Git Repository
https://github.com/liviahoxha/EDE_Fall2023/tree/main/Assignments
